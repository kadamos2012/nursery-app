...
TRANSLATIONS = {
    "ar": {
        ...
        "financial_summary_month": "الملخص المالي لهذا الشهر",
        "tuition_collected": "إيراد المصروفات الدراسية (المحصّل)",
        "due_not_collected": "مستحق ولسه ما اتحصلش",
        "general_expenses": "المصروفات العامة",
        "salaries_paid": "مرتبات مدفوعة",
        "net_profit_month": "صافي الربح هذا الشهر (بعد المصروفات والمرتبات وتكلفة الأنشطة)",
        "quick_overview": "لمحة سريعة",
        "classes_count": "عدد الفصول",
        "students_count_label": "عدد الطلبة",
        "active_staff_count": "عدد الموظفين النشطين",
        "add_new_class": "إضافة فصل جديد",
        "class_name_placeholder": "اسم الفصل، مثال: الفراشات",
        "add_class": "إضافة الفصل",
        "all_classes": "كل الفصول",
        "class_name": "اسم الفصل",
        "manage_students": "إدارة الطلبة ←",
        "weekly_schedule_link": "الجدول الأسبوعي ←",
        "pricing_link": "التسعير ←",
        "class_photos_link": "صور الفصل ←",
        "back_to_classes": "← رجوع للفصول",
        "class_pricing_full": "تسعير فصل {name} (دوام كامل/جزئي، ساعات إضافية) ←",
        "register_new_student": "تسجيل طالب جديد في {name}",
        "child_name_placeholder": "اسم الطفل",
        "birth_date": "تاريخ الميلاد",
        "subscription_type_auto": "نوع الاشتراك (السعر بياخده تلقائي من تسعير الفصل)",
        "full_time_option": "دوام كامل (Full time)",
        "part_time_option": "دوام جزئي (Part time)",
        "register_student_btn": "تسجيل الطالب",
        "archived_students": "الطلبة المؤرشفين",
        "registered_students": "الطلبة المسجلين",
        "back_to_active_students": "← رجوع للطلبة النشطين",
        "view_archived_students": "عرض الطلبة المؤرشفين ←",
        "age": "السن", "years_old": "سنة",
        "base_subscription": "الاشتراك الأساسي", "extra": "إضافي", "total": "الإجمالي",
        "no_parent_linked": "مفيش ولي أمر مربوط",
        "full_time": "دوام كامل", "part_time": "دوام جزئي",
        "days_used": "أيام مستخدمة",
        "discount": "خصم",
        "medical_note_exists": "⚠ يوجد ملاحظة طبية",
        "photo_medical_link": "الصورة/الطبي ←",
        "authorized_pickup_link": "مصرح لهم بالاستلام ←",
        "medication_task_placeholder": "موعد دوا/مهمة",
        "time_placeholder": "الوقت",
        "unarchive": "إلغاء الأرشفة", "archive": "أرشفة",
        "add_new_employee": "إضافة موظف جديد",
        "employee_name_placeholder": "اسم الموظف",
        "role_placeholder": "الوظيفة، مثال: معلمة",
        "phone_short": "رقم الهاتف",
        "monthly_salary_placeholder": "المرتب الشهري",
        "add_employee": "إضافة الموظف",
        "employees_salaries": "الموظفين",
        "salaries_for": "مرتبات",
        "role": "الوظيفة", "salary": "المرتب", "outstanding_advances": "سلف مستحقة",
        "net": "الصافي", "payment_status": "حالة الصرف",
        "record_history": "السجل ←",
        "credentials_link": "شهادات ←",
        "timeclock_link": "بصمة الحضور ←",
        "paid_status": "اتصرف",
        "method": "الطريقة",
        "disburse": "اصرف",
        "record_advance": "تسجيل سلفة لموظف",
        "select_employee": "اختاري الموظف",
        "advance_amount_placeholder": "مبلغ السلفة",
        "note_optional": "ملاحظة (اختياري)",
        "record_advance_btn": "تسجيل السلفة",
        "advance_note": "السلفة بتتخصم تلقائي من مرتب الموظف أول ما تصرفيله مرتبه",
        "manage_expense_items": "إدارة بنود المصروف ←",
        "record_new_expense": "تسجيل مصروف جديد",
        "choose_expense_type": "اختاري نوع المصروف",
        "expense_desc_placeholder": "وصف المصروف (اختياري)",
        "amount_egp_placeholder": "المبلغ بالجنيه",
        "disbursement_method_optional": "طريقة الصرف (اختياري)",
        "record_expense_btn": "تسجيل المصروف",
        "all_expenses_total": "كل المصروفات — إجمالي",
        "type": "النوع", "description": "الوصف",
        "download_excel_report": "⬇ تحميل التقرير Excel",
        "choose_month": "اختاري الشهر",
        "show": "عرض",
        "revenue": "الإيراد",
        "tuition_collected_row": "مصروفات دراسية محصّلة",
        "tuition_due_row": "مصروفات دراسية مستحقة (لسه)",
        "expenses_by_type": "المصروفات حسب النوع",
        "no_expenses_month": "لا توجد مصروفات مسجلة هذا الشهر",
        "total_general_expenses": "إجمالي المصروفات العامة",
        "activities_cost_row": "تكلفة الأنشطة",
        "net_profit": "صافي الربح",
        "net_profit_formula": "= الإيراد المحصّل − (المصروفات العامة + المرتبات المدفوعة + تكلفة الأنشطة)",
        "students_paren": "الطلبة",
        "expected_amount": "المستحق",
        "paid_with": "مدفوع",
        "still_due": "لسه",
        "collection_method": "طريقة التحصيل",
        "collect": "تحصيل",
        "need_methods_first": "محتاجة تضيفي طرق تحصيل الأول من",
        "here_link": "هنا ←",
        "logo_alt": "اللوجو",
    ...
    "en": {
        ...
        "financial_summary_month": "This month's financial summary",
        "tuition_collected": "Tuition revenue (collected)",
        "due_not_collected": "Due but not yet collected",
        "general_expenses": "General expenses",
        "salaries_paid": "Salaries paid",
        "net_profit_month": "Net profit this month (after expenses, salaries, and activity costs)",
        "quick_overview": "Quick overview",
        "classes_count": "Number of classes",
        "students_count_label": "Number of students",
        "active_staff_count": "Active staff members",
        "add_new_class": "Add a new class",
        "class_name_placeholder": "Class name, e.g. Butterflies",
        "add_class": "Add class",
        "all_classes": "All classes",
        "class_name": "Class name",
        "manage_students": "Manage students →",
        "weekly_schedule_link": "Weekly schedule →",
        "pricing_link": "Pricing →",
        "class_photos_link": "Class photos →",
        "back_to_classes": "← Back to classes",
        "class_pricing_full": "{name} class pricing (full/part time, overtime) →",
        "register_new_student": "Register a new student in {name}",
        "child_name_placeholder": "Child's name",
        "birth_date": "Birth date",
        "subscription_type_auto": "Subscription type (price comes from class pricing automatically)",
        ...
        "back_to_active_students": "← Back to active students",
        "view_archived_students": "View archived students →",
        "age": "Age", "years_old": "yrs",
        "base_subscription": "Base subscription", "extra": "Add-ons", "total": "Total",
        "no_parent_linked": "No parent linked",
        "full_time": "Full time", "part_time": "Part time",
        "days_used": "Days used",
        "discount": "Discount",
        "medical_note_exists": "⚠ Medical note on file",
        "photo_medical_link": "Photo/Medical →",
        "authorized_pickup_link": "Authorized pickup →",
        "medication_task_placeholder": "Medication/appointment",
        "time_placeholder": "Time",
        "unarchive": "Unarchive", "archive": "Archive",
        "add_new_employee": "Add new employee",
        "employee_name_placeholder": "Employee name",
        "role_placeholder": "Role, e.g. Teacher",
        "phone_short": "Phone number",
        "monthly_salary_placeholder": "Monthly salary",
        "add_employee": "Add employee",
        "employees_salaries": "Staff",
        "salaries_for": "salaries for",
        "role": "Role", "salary": "Salary", "outstanding_advances": "Outstanding advances",
        "net": "Net", "payment_status": "Payment status",
        "record_history": "History →",
        "credentials_link": "Credentials →",
        "timeclock_link": "Time clock →",
        "paid_status": "Paid",
        "method": "Method",
        "disburse": "Pay",
        "record_advance": "Record a staff advance",
        "select_employee": "Select employee",
        "advance_amount_placeholder": "Advance amount",
        "note_optional": "Note (optional)",
        "record_advance_btn": "Record advance",
        "advance_note": "The advance is deducted automatically from the employee's next salary payment",
        "manage_expense_items": "Manage expense categories →",
        "record_new_expense": "Record a new expense",
        "choose_expense_type": "Choose expense type",
        "expense_desc_placeholder": "Expense description (optional)",
        "amount_egp_placeholder": "Amount (EGP)",
        "disbursement_method_optional": "Disbursement method (optional)",
        "record_expense_btn": "Record expense",
        "all_expenses_total": "All expenses — total",
        "type": "Type", "description": "Description",
        "download_excel_report": "⬇ Download Excel report",
        "choose_month": "Choose month",
        "show": "Show",
        "revenue": "Revenue",
        "tuition_collected_row": "Tuition collected",
        "tuition_due_row": "Tuition still due",
        ...
        "activities_cost_row": "Activities cost",
        "net_profit": "Net profit",
        "net_profit_formula": "= Revenue collected − (general expenses + salaries paid + activity costs)",
        ...
        "collect": "Collect",
        "need_methods_first": "You need to add collection methods first from",
        "here_link": "here →",
        "logo_alt": "Logo",
